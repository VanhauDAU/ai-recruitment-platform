...
SETTINGS = [
    ...
    (
        ...
        G.GENERAL,
        T.TEXT,
        'Nền tảng việc làm & AI Career Coach',
        True,
    ...
    (
        'candidate_allow_registration',
        'Cho phép đăng ký ứng viên',
        G.CANDIDATE,
        T.BOOLEAN,
        True,
        True,
    ...
    (
        'candidate_require_email_verification',
    ...
    (
        'candidate_max_applications_per_day',
        'Giới hạn ứng tuyển mỗi ngày',
        G.CANDIDATE,
        T.NUMBER,
        20,
        False,
    ...
    (
        'candidate_profile_completion_required',
        'Bắt buộc hoàn thiện hồ sơ để ứng tuyển',
        G.CANDIDATE,
        T.BOOLEAN,
        False,
        True,
    ...
    # ---- 5. Nhà tuyển dụng ----
    (
        'employer_allow_registration',
        'Cho phép đăng ký NTD',
        G.EMPLOYER,
        T.BOOLEAN,
        True,
        True,
    ...
    (
        'employer_require_approval',
        'Duyệt tài khoản NTD trước khi hoạt động',
        G.EMPLOYER,
        T.BOOLEAN,
        True,
        False,
    ...
    (
        'employer_require_company_info',
        'Bắt buộc thông tin công ty',
        G.EMPLOYER,
        T.BOOLEAN,
        True,
        False,
    ...
    (
        'employer_max_active_jobs',
        'Số tin đang đăng tối đa',
        G.EMPLOYER,
        T.NUMBER,
        10,
        False,
    ...
    (
        ...
        'Lượt đăng tin miễn phí khi chưa đủ xác thực',
        G.EMPLOYER,
        T.NUMBER,
        3,
        False,
        'Quota đăng tin trọn đời cho tài khoản chưa hoàn tất xác thực hồ sơ hoặc chưa đạt Cấp 3. Đóng hoặc hết hạn tin không hoàn lượt.',
        {},
    ),
    (
        'employer_verified_level_three_job_quota',
        'Lượt đăng tin sau xác thực Cấp 3',
        G.EMPLOYER,
        T.NUMBER,
        100,
        False,
        'Quota đăng tin trọn đời khi hồ sơ xác thực của chính tài khoản đã hoàn tất và tài khoản đạt Cấp 3. Những tin miễn phí đã dùng được tính trong quota này.',
        {},
    ),
    (
    ...
    (
        ...
        [
            ...
            {
                'value': '10.000+',
                'label_vi': 'hồ sơ ứng viên trên nền tảng',
                'label_en': 'candidate profiles',
            },
            {
                'value': '80%',
                'label_vi': 'độ chính xác AI gợi ý ứng viên',
                'label_en': 'AI matching accuracy',
            },
            {
                'value': '34',
                'label_vi': 'tỉnh/thành có dữ liệu tuyển dụng',
                'label_en': 'provinces covered',
            },
            {
                'value': '24/7',
                'label_vi': 'hệ thống nhận hồ sơ trực tuyến',
                'label_en': 'online application intake',
            },
            {
                'value': '5 phút',
                'label_vi': 'để đăng một tin tuyển dụng',
                'label_en': 'to post a job',
            },
        ],
        True,
    ...
    (
        'employer_partners',
        'Khách hàng tiêu biểu (trang NTD)',
        G.EMPLOYER,
        T.JSON,
        [],
        True,
    ...
    (
        'employer_hotline_north',
        'Hotline tư vấn miền Bắc',
        G.EMPLOYER,
        T.TEXT,
        '',
        True,
    ...
    (
        'employer_hotline_south',
        'Hotline tư vấn miền Nam',
        G.EMPLOYER,
        T.TEXT,
        '',
        True,
    ...
    (
        'job_allow_salary_negotiable',
        'Cho phép lương thoả thuận',
        G.JOBS,
        T.BOOLEAN,
        True,
        True,
    ...
    (
        ...
        '',
        False,
        'Cấu hình qua biến môi trường, không lưu trong DB.',
        {'env_var': 'EMAIL_HOST_PASSWORD'},
    ),
    (
        'email_notify_new_application',
        'Báo NTD khi có ứng tuyển mới',
        G.EMAIL,
        T.BOOLEAN,
        True,
        False,
    ...
    (
        'email_notify_job_approved',
        'Báo NTD khi tin được duyệt',
        G.EMAIL,
        T.BOOLEAN,
        True,
        False,
    ...
    (
        ...
        G.EMAIL,
        T.TEXTAREA,
        'ProCV - Nền tảng việc làm & AI Career Coach',
        False,
        '',
        {},
    ),
    ...
    (
        ...
        ['jpg', 'png', 'webp', 'gif'],
        True,
        'Danh sách đuôi file, dạng JSON array.',
        {},
    ),
    (
        'upload_allowed_cv_types',
        'Định dạng CV cho phép',
        G.UPLOAD,
        T.JSON,
        ['pdf', 'doc', 'docx'],
        True,
    ...
    (
        ...
        G.FOOTER,
        T.TEXTAREA,
        'ProCV - Nền tảng việc làm và phát triển sự nghiệp cùng AI dành cho người Việt.',
        True,
        '',
        {},
    ),
    ...
    (
        'footer_show_link_groups',
        'Hiện menu điều hướng',
        G.FOOTER,
        T.BOOLEAN,
        True,
        True,
    ...
    (
        ...
        'Thông tin giấy phép / mã số thuế',
        G.FOOTER,
        T.TEXTAREA,
        '',
        True,
    ...
    (
        'admin_allow_staff_creation',
        'Cho phép tạo tài khoản quản trị phụ',
        G.ADMIN_ROLES,
        T.BOOLEAN,
        False,
        False,
    ...
    (
        'speech_enabled',
        'Bật hệ thống giọng đọc',
        G.AI,
        T.BOOLEAN,
        False,
        True,
        'Công tắc tổng; hard switch production vẫn có quyền ưu tiên cao hơn.',
        {},
    ),
    (
        'speech_live_enabled',
        'Cho phép tổng hợp giọng đọc trực tiếp',
        G.AI,
        T.BOOLEAN,
        False,
        True,
        'Chỉ bật sau khi benchmark trên cấu hình production đạt yêu cầu.',
        {},
    ),
    ('speech_blog_enabled', 'Giọng đọc Blog', G.AI, T.BOOLEAN, False, True, '', {}),
    (
        'speech_onboarding_enabled',
        'Giọng đọc Onboarding',
        G.AI,
        T.BOOLEAN,
        False,
        True,
    ...
    ('speech_chatbot_enabled', 'Giọng đọc Chatbot', G.AI, T.BOOLEAN, False, True, '', {}),
    (
        'speech_interview_enabled',
        'Giọng đọc Phỏng vấn',
        G.AI,
        T.BOOLEAN,
        False,
        True,
        'Giữ tắt trong giai đoạn 0–2.',
        {},
    ),
    (
    ...
    (
        'speech_daily_anonymous_limit',
        'Lượt tạo giọng đọc/ngày/IP',
        G.AI,
        T.NUMBER,
        30,
        False,
...
LINK_GROUPS = [
    ...
    (
        ...
        3,
        [
            ('Đăng tin tuyển dụng', '/tuyendung'),
            ('Giải pháp tuyển dụng', '/tuyendung/dich-vu'),
            ('Bảng giá dịch vụ', '/tuyendung/bao-gia'),
            ('Đăng nhập nhà tuyển dụng', '/tuyendung/app/login'),
        ],
    ),
]
...
BANNERS = [
    ...
    (
        ...
        'Tạo CV chuẩn ATS miễn phí — ứng tuyển ngay khi có việc phù hợp',
        'GỢI Ý CHO BẠN',
    ...
    def handle(self, *args, **options):
        ...
        for key, label, group, value_type, value, is_public, description, opts in SETTINGS:
            ...
            setting, created = SiteSetting.objects.get_or_create(
                key=key, defaults={**metadata, 'value': value}
            )
            if not created:
                changed = False
