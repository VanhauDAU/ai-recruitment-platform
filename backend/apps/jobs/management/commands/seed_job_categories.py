...
POSITION_LOCALIZATIONS = {
    'AI/Machine Learning Engineer': {'en-US': 'AI/Machine Learning Engineer', 'ja-JP': 'AI・機械学習エンジニア', 'zh-CN': '人工智能/机器学习工程师'},
    'Android Developer': {'en-US': 'Android Developer', 'ja-JP': 'Android開発者', 'zh-CN': 'Android开发工程师'},
    'Automation Tester': {'en-US': 'Automation Tester', 'ja-JP': '自動化テスター', 'zh-CN': '自动化测试工程师'},
    'Backend Developer': {'en-US': 'Backend Developer', 'ja-JP': 'バックエンド開発者', 'zh-CN': '后端开发工程师'},
    'Bảo vệ': {'en-US': 'Security Guard', 'ja-JP': '警備員', 'zh-CN': '保安员'},
    'C&B': {'en-US': 'Compensation & Benefits Specialist', 'ja-JP': 'C&B担当者', 'zh-CN': '薪酬福利专员'},
    'Chuyên viên thuế': {'en-US': 'Tax Specialist', 'ja-JP': '税務スペシャリスト', 'zh-CN': '税务专员'},
    'Cloud Engineer': {'en-US': 'Cloud Engineer', 'ja-JP': 'クラウドエンジニア', 'zh-CN': '云计算工程师'},
    'Công nhân sản xuất': {'en-US': 'Production Worker', 'ja-JP': '製造作業員', 'zh-CN': '生产工人'},
    'Content Marketing': {'en-US': 'Content Marketing Specialist', 'ja-JP': 'コンテンツマーケティング担当', 'zh-CN': '内容营销专员'},
    ...
    'DevOps Engineer': {'en-US': 'DevOps Engineer', 'ja-JP': 'DevOpsエンジニア', 'zh-CN': 'DevOps工程师'},
    'Đóng gói': {'en-US': 'Packing Worker', 'ja-JP': '梱包作業員', 'zh-CN': '包装工'},
    'Frontend Developer': {'en-US': 'Frontend Developer', 'ja-JP': 'フロントエンド開発者', 'zh-CN': '前端开发工程师'},
    'Fullstack Developer': {'en-US': 'Fullstack Developer', 'ja-JP': 'フルスタック開発者', 'zh-CN': '全栈开发工程师'},
    'Graphic Designer': {'en-US': 'Graphic Designer', 'ja-JP': 'グラフィックデザイナー', 'zh-CN': '平面设计师'},
    'Hành chính văn phòng': {'en-US': 'Office Administrator', 'ja-JP': 'オフィス管理スタッフ', 'zh-CN': '行政文员'},
    'iOS Developer': {'en-US': 'iOS Developer', 'ja-JP': 'iOS開発者', 'zh-CN': 'iOS开发工程师'},
    'IT Helpdesk': {'en-US': 'IT Helpdesk Specialist', 'ja-JP': 'ITヘルプデスク担当', 'zh-CN': 'IT服务台专员'},
    'IT phần cứng/mạng': {'en-US': 'IT Hardware/Network Specialist', 'ja-JP': 'ITハードウェア・ネットワーク担当', 'zh-CN': 'IT硬件与网络专员'},
    'Kế toán công nợ': {'en-US': 'Accounts Receivable/Payable Accountant', 'ja-JP': '債権債務会計担当', 'zh-CN': '往来会计'},
    'Kế toán nội bộ': {'en-US': 'Internal Accountant', 'ja-JP': '社内会計担当', 'zh-CN': '内部会计'},
    'Kế toán tổng hợp': {'en-US': 'General Accountant', 'ja-JP': '総合会計担当', 'zh-CN': '总账会计'},
    'Kiểm toán nội bộ': {'en-US': 'Internal Auditor', 'ja-JP': '内部監査担当', 'zh-CN': '内部审计师'},
    'Kinh doanh nội thất': {'en-US': 'Interior Sales Specialist', 'ja-JP': 'インテリア営業担当', 'zh-CN': '家居销售专员'},
    'Kinh doanh thiết bị/vật liệu xây dựng': {'en-US': 'Construction Equipment/Materials Sales', 'ja-JP': '建設設備・資材営業', 'zh-CN': '建筑设备/材料销售'},
    'Lái xe/Giao hàng': {'en-US': 'Driver/Delivery Staff', 'ja-JP': 'ドライバー・配送スタッフ', 'zh-CN': '司机/配送员'},
    ...
    'Môi giới bất động sản': {'en-US': 'Real Estate Broker', 'ja-JP': '不動産仲介担当', 'zh-CN': '房地产经纪人'},
    'Nhân viên CSKH': {'en-US': 'Customer Service Representative', 'ja-JP': 'カスタマーサポート担当', 'zh-CN': '客户服务专员'},
    'Nhân viên kho': {'en-US': 'Warehouse Staff', 'ja-JP': '倉庫スタッフ', 'zh-CN': '仓库管理员'},
    'Pháp chế doanh nghiệp': {'en-US': 'Corporate Legal Specialist', 'ja-JP': '企業法務担当', 'zh-CN': '企业法务专员'},
    'Photographer': {'en-US': 'Photographer', 'ja-JP': 'フォトグラファー', 'zh-CN': '摄影师'},
    'Quan hệ công chúng': {'en-US': 'Public Relations Specialist', 'ja-JP': '広報担当', 'zh-CN': '公共关系专员'},
    'Quảng cáo Facebook/Google': {'en-US': 'Facebook/Google Ads Specialist', 'ja-JP': 'Facebook・Google広告運用担当', 'zh-CN': 'Facebook/Google广告投放专员'},
    'React Native/Flutter': {'en-US': 'React Native/Flutter Developer', 'ja-JP': 'React Native・Flutter開発者', 'zh-CN': 'React Native/Flutter开发工程师'},
    'Sales Admin': {'en-US': 'Sales Administrator', 'ja-JP': '営業事務', 'zh-CN': '销售行政专员'},
    'Sales Bất động sản khác': {'en-US': 'Other Real Estate Sales', 'ja-JP': 'その他不動産営業', 'zh-CN': '其他房地产销售'},
    'Sales Logistics': {'en-US': 'Logistics Sales Specialist', 'ja-JP': '物流営業担当', 'zh-CN': '物流销售专员'},
    'Sales Online': {'en-US': 'Online Sales Specialist', 'ja-JP': 'オンライン営業担当', 'zh-CN': '在线销售专员'},
    'Sales Xuất nhập khẩu khác': {'en-US': 'Other Import-Export Sales', 'ja-JP': 'その他輸出入営業', 'zh-CN': '其他进出口销售'},
    'SEO/SEM': {'en-US': 'SEO/SEM Specialist', 'ja-JP': 'SEO・SEM担当', 'zh-CN': 'SEO/SEM专员'},
    'System Admin': {'en-US': 'System Administrator', 'ja-JP': 'システム管理者', 'zh-CN': '系统管理员'},
    'Tạp vụ': {'en-US': 'Cleaner', 'ja-JP': '清掃スタッフ', 'zh-CN': '保洁员'},
    'Telesales': {'en-US': 'Telesales Representative', 'ja-JP': 'テレセールス担当', 'zh-CN': '电话销售专员'},
    'Thiết kế nội thất': {'en-US': 'Interior Designer', 'ja-JP': 'インテリアデザイナー', 'zh-CN': '室内设计师'},
    'Thư ký/Trợ lý': {'en-US': 'Secretary/Assistant', 'ja-JP': '秘書・アシスタント', 'zh-CN': '秘书/助理'},
    'Tổ chức sự kiện': {'en-US': 'Event Coordinator', 'ja-JP': 'イベント運営担当', 'zh-CN': '活动策划专员'},
    'Tổng đài viên': {'en-US': 'Call Center Agent', 'ja-JP': 'コールセンター担当', 'zh-CN': '呼叫中心专员'},
    'Trực page': {'en-US': 'Social Media Page Operator', 'ja-JP': 'SNSページ運用担当', 'zh-CN': '社交媒体客服专员'},
    'Tư vấn du học/định cư': {'en-US': 'Study Abroad/Immigration Consultant', 'ja-JP': '留学・移住コンサルタント', 'zh-CN': '留学/移民顾问'},
    'Tư vấn thiết kế xây dựng': {'en-US': 'Construction Design Consultant', 'ja-JP': '建築設計コンサルタント', 'zh-CN': '建筑设计顾问'},
    'Tư vấn tuyển sinh/khoá học': {'en-US': 'Admissions/Course Consultant', 'ja-JP': '入学・講座コンサルタント', 'zh-CN': '招生/课程顾问'},
    'Tuyển dụng': {'en-US': 'Recruitment Specialist', 'ja-JP': '採用担当者', 'zh-CN': '招聘专员'},
    'UI/UX Designer': {'en-US': 'UI/UX Designer', 'ja-JP': 'UI・UXデザイナー', 'zh-CN': 'UI/UX设计师'},
