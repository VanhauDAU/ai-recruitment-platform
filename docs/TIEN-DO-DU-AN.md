...
| ER-1 | Empty/error state, document IDOR và job approval guard | 🟡 ER-1C đã verified |
...
- ER-1 chỉ chuyển hoàn tất sau khi ER-1A empty/error state và ER-1B document
  access-control cũng verified.
