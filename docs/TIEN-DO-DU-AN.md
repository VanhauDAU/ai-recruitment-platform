...
Cập nhật lần cuối: 2026-07-20 (EMP-P1→P11 — cổng marketing, auth, xác thực, GPKD, DLCN, nhu cầu tuyển dụng và trang Thông tin công ty đã hoàn thiện. EMP-P11 bổ sung catalogue nội bộ recent/search phân trang, form Doanh nghiệp/Hộ kinh doanh, rich text an toàn, media nhiều ảnh và update request pháp lý theo quyền owner/member. Chi tiết kiểm chứng nằm ở cập nhật 2026-07-20c cuối tài liệu; các mốc CV Builder, trang chủ và refactor giữ nguyên.)
