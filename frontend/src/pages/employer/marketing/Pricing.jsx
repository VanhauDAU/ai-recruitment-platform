  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl text-center">
        <span className="rounded-full bg-[#00b14f]/10 px-4 py-1.5 text-sm font-bold text-[#008a3e]">Báo giá</span>
        ...
        {PLANS.map((plan) => (
          <article
            ...
            className={`rounded-xl border p-6 shadow-sm ${
              plan.featured ? 'border-[#00b14f] bg-[#f4fff8]' : 'border-gray-100 bg-white'
            }`}
          >
            ...
            <ul className="mt-6 space-y-3">
              {plan.features.map((feature) => (
                <li key={feature} className="flex items-center gap-3 text-sm font-medium text-gray-700">
                  <CheckOutlined className="text-[#00b14f]" />
                  {feature}
                </li>
              ))}
            </ul>
