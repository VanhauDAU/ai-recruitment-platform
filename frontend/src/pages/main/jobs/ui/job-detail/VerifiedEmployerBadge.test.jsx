...
const CRITERIA = [
  ...
  { key: 'no_report_history', label: 'Chưa có lịch sử bị báo cáo tin đăng', passed: true },
]
...
describe('VerifiedEmployerBadge', () => {
  it('lists every criterion sent by the backend on hover', async () => {
    ...
    await userEvent.hover(screen.getByLabelText('Nhà tuyển dụng đã được xác thực'))
