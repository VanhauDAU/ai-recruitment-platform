...
const HOTLINE_TABS = [
  ...
  },
  {
    ...
    email: 'hotro@aicareer.vn',
    badge: 'Tư vấn ngay',
    message: 'AI Career Coach đồng hành cùng đội ngũ tuyển dụng',
    chatData: {
      avatarInitials: 'HR',
      headerName: 'Hỗ Trợ Tuyển Dụng',
      headerStatus: 'Trực tuyến',
      messages: [
        { from: 'recruiter', text: 'Kính chào Quý công ty! AI Career Coach hỗ trợ tìm kiếm ứng viên chất lượng.' },
