export const ADMIN_ROUTES = [
  ...
  { segment: '/access-control', lazyKey: 'AdminAccessControlPage', title: 'Phân quyền quản trị', navLabel: 'Phân quyền', iconKey: 'shield', permission: 'admin_access.view', showInNav: true },
