export const ADMIN_ROUTES = [
  ...
  { segment: '/accounts', lazyKey: 'AdminAccountsPage', title: 'Quản lý tài khoản', navLabel: 'Tài khoản', iconKey: 'accounts', navGroup: 'system', permissionsAny: ['account.view', 'account.admin.view', 'account.admin.invite'], showInNav: true },
  { segment: '/accounts/:publicId', lazyKey: 'AdminAccountDetailPage', title: 'Chi tiết tài khoản', permissionsAny: ['account.view', 'account.admin.view', 'account.admin.invite'], showInNav: false },
