    ...
    <div className="min-h-screen bg-slate-50 py-6">
      <main className="mx-auto max-w-[1600px] px-4">
        ...
        <div className="grid min-w-0 gap-6 xl:grid-cols-[minmax(22rem,0.85fr)_minmax(36rem,1.15fr)]">
          ...
          <aside className="min-w-0 xl:sticky xl:top-4 xl:self-start"><p className="mb-2 text-sm font-semibold text-slate-600">Xem trước A4 · {editor.cv.template_renderer_key || editor.cv.template_version}</p><CvDocumentPreview document={editor.document} rendererKey={editor.cv.template_renderer_key || editor.cv.template_version} /></aside>
        </div>
      </main>
    </div>
  )
