...
class Settings:
    ...
    def from_env(cls) -> Settings:
        ...
        return cls(
            ...
            cache_ttl_seconds=_integer("TTS_CACHE_TTL_SECONDS", 7 * 86400, minimum=60),
            ...
            onnx_threads=_integer("TTS_ONNX_THREADS", 4, minimum=0),
            ...
            fake_engine=os.getenv("TTS_FAKE_ENGINE", "").strip().lower()
            in {"1", "true", "yes"},
        )
